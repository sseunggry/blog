    ...
    const onChange = (e:React.ChangeEvent<HTMLInputElement>) => {
        ...
        if(name === 'password'){
            ...
            if(value?.length < 8){
                ...
                setError("비밀번호와 비밀번호 확인 값이 다릅니다. 다시 입력해주세요.");
            } else {
                setError("");
            }
        }
        ...
        <>
            ...
            <form onSubmit={onSubmit} className="form--small">
                ...
                <div className="form__block">
                    ...
                    <input type="password" name="password_confirm" id="password_confirm" value={passwordConfirm} onChange={onChange} required />
                </div>
